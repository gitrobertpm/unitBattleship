...
describe('PLAYER METHODS', function () {
	describe('validateLocation', function () {
		var validateLocation = require('../src/js/game_logic/player_methods.js').validateLocation;
		var player;
	...
	describe('validateLocations', function () {
		var validateLocations = require('../src/js/game_logic/player_methods.js').validateLocations;
		var player;
	...
	describe('placeShip', function () {
		var placeShip = require('../src/js/game_logic/player_methods.js').placeShip;
		var player;
		...
		it('should throw an error if no direction is specified', function() {
			...
			expect(handler).to.throw('You left out the direction, need that for math');
		});
